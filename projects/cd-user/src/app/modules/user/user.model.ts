...
export const UserModel: FieldInfo[] = [
    ...
    { title: 'Password', name: 'password', dbName: 'password', type: FieldType.string, fetchable: false, updateable: false, searchable: false, show: false, controls: [{ controlType: ControlType.text, fieldFor: FieldFor.createForm }, { controlType: ControlType.text, fieldFor: FieldFor.tableDisplay }], formatt: 'text', isNameField: true, savable: true, formControlsConfig: ['', [Validators.minLength(3), Validators.maxLength(20), Validators.required, Validators.pattern('^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$')]] },
    { title: 'ConfirmPassword', name: 'confirmPassword', dbName: 'confirmPassword', type: FieldType.string, fetchable: false, updateable: false, searchable: false, show: false, controls: [{ controlType: ControlType.text, fieldFor: FieldFor.createForm }, { controlType: ControlType.text, fieldFor: FieldFor.tableDisplay }], formatt: 'text', isNameField: true, savable: false, formControlsConfig: ['', [Validators.minLength(3), Validators.maxLength(20), Validators.required, Validators.pattern('^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$')]] },
